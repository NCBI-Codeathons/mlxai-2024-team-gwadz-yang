...
# Define a more complex neural network architecture with batch normalization and increased dropout
...
# Increase the learning rate and adjust the optimizer
optimizer = optim.Adam(model.parameters(), lr=0.01, weight_decay=1e-5)  # Increase learning rate
